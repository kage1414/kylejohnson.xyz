...
const AllowBareDDL: $AllowBareDDL = $.makeType<$AllowBareDDL>(_.spec, "6e4a07c6-6791-11ed-bb0c-4ffe21d43f3f", _.syntax.literal);
...
const ConnectionTransport: $ConnectionTransport = $.makeType<$ConnectionTransport>(_.spec, "6e4a9222-6791-11ed-b4d0-9f06d335d31e", _.syntax.literal);
...
const $ConfigObject = $.makeType<$ConfigObject>(_.spec, "6e4b4d2a-6791-11ed-a2b2-115a72d0e7d4", _.syntax.literal);
...
const $AbstractConfig = $.makeType<$AbstractConfig>(_.spec, "6e9038fe-6791-11ed-80e2-0da34d8db56c", _.syntax.literal);
...
const $Auth = $.makeType<$Auth>(_.spec, "6e7d7728-6791-11ed-845c-b3a5b8596215", _.syntax.literal);
...
const $AuthMethod = $.makeType<$AuthMethod>(_.spec, "6e542f1c-6791-11ed-b95c-7d2b5cb86bd1", _.syntax.literal);
...
const $Config = $.makeType<$Config>(_.spec, "6eb4d312-6791-11ed-9f7e-f7325d544f24", _.syntax.literal);
...
const $DatabaseConfig = $.makeType<$DatabaseConfig>(_.spec, "6f026ece-6791-11ed-ac9c-0fa7c505c1ee", _.syntax.literal);
...
const $InstanceConfig = $.makeType<$InstanceConfig>(_.spec, "6edb875a-6791-11ed-8571-51bfaa07c598", _.syntax.literal);
...
const $JWT = $.makeType<$JWT>(_.spec, "6e726bda-6791-11ed-99a1-77d755f146fa", _.syntax.literal);
...
const $SCRAM = $.makeType<$SCRAM>(_.spec, "6e67923c-6791-11ed-a005-bf213dbc7ae0", _.syntax.literal);
...
const $Trust = $.makeType<$Trust>(_.spec, "6e5dde2c-6791-11ed-a1b5-1930d2a431f7", _.syntax.literal);

...
const JsonEmpty: $JsonEmpty = $.makeType<$JsonEmpty>(_.spec, "67464688-6791-11ed-9932-39f2f45e3c64", _.syntax.literal);
...
const $sequence: $sequence = $.makeType<$sequence>(_.spec, "62fec848-6791-11ed-904b-2f9e08c42f75", _.syntax.literal);
...
const $BaseObject = $.makeType<$BaseObject>(_.spec, "6874eb04-6791-11ed-a359-bf61ab0a0c0e", _.syntax.literal);
...
export type $Object_68791e22679111ed89064d2d8ee0faf5λShape = $.typeutil.flatten<$BaseObjectλShape & {
}>;
type $Object_68791e22679111ed89064d2d8ee0faf5 = $.ObjectType<"std::Object", $Object_68791e22679111ed89064d2d8ee0faf5λShape, null, [
  ...$BaseObject['__exclusives__'],
]>;
export type $Object = $Object_68791e22679111ed89064d2d8ee0faf5
const $Object_68791e22679111ed89064d2d8ee0faf5 = $.makeType<$Object_68791e22679111ed89064d2d8ee0faf5>(_.spec, "68791e22-6791-11ed-8906-4d2d8ee0faf5", _.syntax.literal);

const Object_68791e22679111ed89064d2d8ee0faf5: $.$expr_PathNode<$.TypeSet<$Object_68791e22679111ed89064d2d8ee0faf5, $.Cardinality.Many>, null> = _.syntax.$PathNode($.$toSet($Object_68791e22679111ed89064d2d8ee0faf5, $.Cardinality.Many), null);
...
const $FreeObject = $.makeType<$FreeObject>(_.spec, "687e22e6-6791-11ed-96e0-056406ef92f1", _.syntax.literal);
...
function min(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::min', args, _.spec, [
    {args: [{typeId: "62f932c0-6791-11ed-88fd-572c1d9dda4e", optional: false, setoftype: true, variadic: false}], returnTypeId: "62f932c0-6791-11ed-88fd-572c1d9dda4e", returnTypemod: "OptionalType", preservesOptionality: true},
    {args: [{typeId: "62ff4e3a-6791-11ed-92a6-b3998d63e119", optional: false, setoftype: true, variadic: false}], returnTypeId: "62ff4e3a-6791-11ed-92a6-b3998d63e119", returnTypemod: "OptionalType", preservesOptionality: true},
...
function contains(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::contains', args, _.spec, [
    ...
    {args: [{typeId: "9ef75dd2-6c6b-2b4f-6d37-4ceaac3ec576", optional: false, setoftype: false, variadic: false}, {typeId: "9ef75dd2-6c6b-2b4f-6d37-4ceaac3ec576", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
    {args: [{typeId: "9ef75dd2-6c6b-2b4f-6d37-4ceaac3ec576", optional: false, setoftype: false, variadic: false}, {typeId: "62f433b0-6791-11ed-aedf-3377d2a2add8", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
...
function range_is_empty(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_is_empty', args, _.spec, [
    {args: [{typeId: "9ef75dd2-6c6b-2b4f-6d37-4ceaac3ec576", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-000000000109"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function range_get_upper(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::range_get_upper', args, _.spec, [
    {args: [{typeId: "9ef75dd2-6c6b-2b4f-6d37-4ceaac3ec576", optional: false, setoftype: false, variadic: false}], returnTypeId: "62f433b0-6791-11ed-aedf-3377d2a2add8", returnTypemod: "OptionalType"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
function sequence_reset(...args: any[]) {
  const {returnType, cardinality, args: positionalArgs, namedArgs} = _.syntax.$resolveOverload('std::sequence_reset', args, _.spec, [
    {args: [{typeId: "6af4e58c-6791-11ed-8b82-4ff9e48bede5", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
    {args: [{typeId: "6af4e58c-6791-11ed-8b82-4ff9e48bede5", optional: false, setoftype: false, variadic: false}, {typeId: "00000000-0000-0000-0000-0000000001ff", optional: false, setoftype: false, variadic: false}], returnTypeId: "00000000-0000-0000-0000-0000000001ff"},
  ]);
  return _.syntax.$expressionify({
    __kind__: $.ExpressionKind.Function,
    __element__: returnType,
...
export { JsonEmpty, bigint, bool, bytes, datetime, decimal, duration, float32, float64, int16, int32, int64, json, $sequence, str, uuid, number, $BaseObject, BaseObject, $Object_68791e22679111ed89064d2d8ee0faf5, Object_68791e22679111ed89064d2d8ee0faf5, $FreeObject, FreeObject };
...
type __defaultExports = {
  ...
  "Object": typeof Object_68791e22679111ed89064d2d8ee0faf5;
...
const __defaultExports: __defaultExports = {
  ...
  "Object": Object_68791e22679111ed89064d2d8ee0faf5,

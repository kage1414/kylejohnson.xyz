  ...
  return (
      <div style={{margin: '10px 0', flex: '1'}}>
        <div style={{margin: '6px'}}>
          <h2 style={{margin: '6px 0', padding: '3px', border: 'rgb(199, 199, 199) 1px solid', backgroundColor: 'rgb(240, 243, 252'}}>{employer}<span style={{margin: '0 10px', fontWeight: 'normal'}}>{time}</span></h2>
